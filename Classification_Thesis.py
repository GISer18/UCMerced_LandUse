...
callbacks_list = [checkpoint_class_loss,checkpoint_image_loss,checkpoint_class_acc,checkpoint_image_acc]#,tensorboard]#,reduce_lr]
#%%
batch_size = 64
num_classes = 4
epochs = 150    
...
seq = keras.layers.BatchNormalization()(seq)
seq = keras.layers.Activation("relu")(seq)
shortcut2 = keras.layers.Conv2D(filters=n_filters*2, kernel_size=(1, 1),strides=(1,1), padding="same")(seq)
...
#convT1
seq = keras.layers.Conv2DTranspose(filters=n_filters*4, kernel_size=(3, 3), padding="same")(seq)
seq = keras.layers.BatchNormalization()(seq)
seq = keras.layers.Activation("relu")(seq)
seq = keras.layers.Conv2DTranspose(filters=n_filters*4, kernel_size=(3, 3), padding="same")(seq)
seq = keras.layers.BatchNormalization()(seq)
...
#convT2
seq = keras.layers.Conv2DTranspose(filters=n_filters*2, kernel_size=(3, 3), padding="same")(seq)
seq = keras.layers.BatchNormalization()(seq)
seq = keras.layers.Activation("relu")(seq)
seq = keras.layers.Conv2DTranspose(filters=n_filters*2, kernel_size=(3, 3), padding="same")(seq)
seq = keras.layers.BatchNormalization()(seq)
